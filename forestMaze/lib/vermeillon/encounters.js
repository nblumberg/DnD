...
class ToxicWeirdEncounter extends Encounter {
    ...
    constructor() {
        ...
        Make a Dexterity saving throw to dodge the crashing wave.`,
            ...
            failure: makeSavingThrow(10, takeDamage({
    ...
    valid(location) {
        ...
        return super.valid(location) && !!(priorLocation && priorLocation.acidLake && this.lastLocation.acidLake);
    }
}
const insects = [
...
class InsectSwarmEncounter extends Encounter {
    constructor() {
        ...
        const name = () => {
            ...
            this.image = image;
            this.failure = makeSavingThrow(13, takeDamage({
        ...
        super({
            name,
            description: '', // will be replaced by invoking name()
        });
    }
}
export const encounters = [
    ...
    new Encounter({
        ...
        failure: makeSavingThrow(12, takeDamage({
