/* global define */
/* exported DnD.Dialog.Image */
(function() {
    "use strict";

    define({
        name: "Dialog.Image",
        dependencyNames: [ "Dialog", "jQuery", "console" ],
        factory: function(Dialog, jQuery, console) {
            ...
            ImageDialog.prototype._fetchUrl = function() { // function(event) {
                var url, value;
