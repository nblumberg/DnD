    ...
    DnD.define(
        ...
        function(jQuery, Creature) {
            var o = {
                ...
                init: 15, speed: { walk: 7, teleport: 7 },
                abilities: { STR: 16, CON: 14, DEX: 25, INT: 5, WIS: 21, CHA: 19 },
                skills: {},
                attacks: [
                    ...
                    { name: "Portal Walk", usage: { frequency: "Encounter", action: "move" }, target: { area: "close", size: 1 }, toHit: 21, defense: "Will", damage: "0", keywords: [ "close", "burst", "teleportation" ] }
                ]
            };
