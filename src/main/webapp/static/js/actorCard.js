...
(function() {
    ...
    define({
        name: "Display.ActorCard",
        dependencyNames: [ "Effect", "jQuery", "console" ],
        factory: function(Effect, jQuery, console) {
...
//                }).bind(this) });
            ...
            ActorCard.Condition.prototype._render = function() {
                ...
                condition = Effect.CONDITIONS[ this.effect.name.toLowerCase() ];
