    ...
    return { 
        ...
        Festivus: { 
             ...
             attacks: [
                       ...
                       { name: "Vicious Mockery", usage: { frequency: "At-Will" }, toHit: "CHA", defense: "Will", damage: { amount: "1d6+9", type: "psychic", crit: "1d8" }, effects: [ { name: "penalty", type: "attacks", amount: -2, duration: "endAttackerNext" } ], keywords: [ "arcane", "charm", "implement", "psychic" ] },
         ...
         Kitara: { 
             ...
             attacks: [
                       ...
                       { name: "Ghoul Strike", usage: { frequency: "Encounter" }, toHit: "INT", isMelee: true, target: { range: 5 }, defense: "Fort", damage: { amount: "2d6+INT", type: "necrotic" }, miss: { notExpended: true }, effects: [ { name: "Immobilized", duration: "endAttackerNext" }], keywords: [ "arcane", "implement", "necromancy", "necrotic", "shadow", "zone", "ranged" ] },
                       { name: "Ghoul Strike (zone)", usage: { frequency: "At-Will" }, toHit: "automatic", target: { area: "close burst", size: 2 }, defense: "Fort", damage: { amount: "5", type: "necrotic" }, effects: [ { name: "Combat Advantage" }], keywords: [ "arcane", "implement", "necromancy", "necrotic", "shadow", "zone" ] },
                       { name: "Thunder Cage", usage: { frequency: "Encounter" }, toHit: "INT", target: { range: 10 }, defense: "Fort", damage: { amount: "2d10+INT", type: "thunder" }, keywords: [ "arcane", "evocation", "implement", "ranged", "thunder" ] },
                       { name: "Thunder Cage (secondary)", usage: { frequency: "Encounter" }, toHit: "automatic", target: { range: 10 }, defense: "Fort", damage: { amount: "1d10+INT", type: "thunder" }, keywords: [ "arcane", "evocation", "implement", "ranged", "thunder" ] },
