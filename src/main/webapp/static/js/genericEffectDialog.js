(function() {
    ...
    DnD.define(
        ...
        function(w, Dialog, jQuery, out, K, Attack) {
            ...
            GenericEffectDialog.prototype = new Dialog("attacksDialog", "/html/partials/GenericEffectDialog.html");
            ...
            GenericEffectDialog.prototype.show = function(params) {
                ...
                if (!params || !params.attacker || !params.actors) {
                    try { out.console.warn("GenericEffectDialog.show() invoked without sufficient parameters"); } finally {}
                    return;
                }
            ...
            GenericEffectDialog.prototype._resolveAttack = function() {
            ...
            GenericEffectDialog.prototype._stringifyDamage = function() {
                var d, w, plus;
            ...
            GenericEffectDialog.prototype._attackChange = function($a) {
            ...
            GenericEffectDialog.prototype._weaponChange = function() {
            ...
            GenericEffectDialog.prototype._playerAttackChange = function() {
