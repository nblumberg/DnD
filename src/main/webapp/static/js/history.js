/* global define */
/* exported DnD.History, DnD.History.Entry, DnD.History.Editor */
(function() {
    "use strict";

    define({
        name: "History",
        dependencyNames: [ "Serializable", "EventDispatcher", "state", "jQuery", "console" ],
        factory: function(Serializable, EventDispatcher, state, jQuery, console) {
...
//                return raw;
            ...
            History.Entry.prototype._getSubjectName = function(warn) {
                if (typeof(this.subject) === "number") {
                    ...
                    this.subject = state.findActor(this.subject, true);
                }
