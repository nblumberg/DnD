(function() {
    ...
    DnD.define(
        ...
        [ "Display.Dialog", "jQuery", "out", "Roll", "Actor", "K" ],
        function(Dialog, jQuery, out, Roll, Actor, K) {
            ...
            InitiativeDialog.prototype._resolveInitiative = function() {
                ...
                for (i = 0; i < entries.length; i++) {
                    actor = Actor.findActor(entries[ i ].id);
                ...
                out.console.info("New order: " + test + " ]");
                this.hide();
            ...
            InitiativeDialog.prototype._populate = function() {
                ...
                for (i = 0; i < this.order.length; i++) {
                    ...
                    if (!actor) {
                        out.console.warn("Skipping order #" + i + " (actor id " + this.order[ i ] + "), not found in the list of actors");
                        continue;
                    }
                    $li = jQuery("<li/>").addClass("ui-state-default grab actor active").data("actor", actor).appendTo(this.$sortable);
                    $a = jQuery("<a href=\"" + K.NO_URL + "\"/>").appendTo($li);
