    ...
    DnD.define(
        ...
        function(Editor) {
            describe("editor.js", function() {
                ...
                beforeEach(function() {
                    var isKarma = window.self !== window.top;
                    jasmine.getFixtures().fixturesPath = (isKarma ? "/base" : "") + "/src/test/webapp/jasmine/spec/javascripts/fixtures/";
                    loadFixtures("editor.html");
                    $div = jQuery("#editorParent");
                    params = {
                        $parent: $div,
                        tagName: "span",
                ...
                describe("User interaction", function() {
                    describe("text display", function() {
                        it("on click it should switch to edit mode", function() {
                            ...
                            expect(editor._edit).toHaveBeenCalled();
                        });
                    ...
                    describe("editor buttons", function() {
                        ...
                        it("on click the save button should switch to display mode", function() {
                            ...
                            expect(editor._save).toHaveBeenCalled();
                        });
                        ...
                        it("on click the cancel button should switch to display mode", function() {
                            ...
                            expect(editor._cancel).toHaveBeenCalled();
                        });
