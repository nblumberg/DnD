...
(function() {
    ...
    describe("event.js", function() {
        describe("EventDispatcher", function() {
            ...
            eventDispatcher = event = callback = count = spyObj = null;

            beforeEach(function() {
                eventDispatcher = new DnD.EventDispatcher();
                event = { type: "test" };
                callback = function() {};
            });
            ...
            describe("dispatchEvent()", function() {
                ...
                it("should increment the event id counter for each dispatched event", function() {
                    expect(DnD.EventDispatcher.id).toEqual(3);
                });
