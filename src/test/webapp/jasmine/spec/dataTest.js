(function(module, EFFECT_CONDITIONS) {
    "use strict";
    ...
    describe("data.js", function() {
        var randEffectTest = function() {
            ...
            itObjectEffect = function() {
                expect(EFFECT_CONDITIONS.hasOwnProperty(effect.name)).toEqual(true);
            };
            for (i = 0; i < 1; i++) {
                effect = DnD.data.randEffect();
                it("Object", itObject);
        ...
        describe("When DnD.data.randEffect() is invoked it should return an it should return an", randEffectTest);

        describe("When DnD.data.randEffects() is invoked it should return an", function() {
        ...
        describe("When DnD.data.loadInitiative() is invoked it should return an", function() {
            var result;
            result = module.loadInitiative();
            it("Object", function() {
...
})(DnD.data, DnD.Effect.CONDITIONS);
