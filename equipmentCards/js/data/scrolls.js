...
export default [
  createScroll({
    name: "Scroll of Speak with Plants",
    hero: "https://i.etsystatic.com/10002881/r/il/722765/5739101803/il_fullxfull.5739101803_7hjc.jpg",
    level: 3,
    activate: "1A",
    target: "🧙 30'",
    ...
    tags: "COMMUNICATION,BUFF,1/2/26",
    description: `Within an immobile 30' area:
    <ul>
    <li>Communicate with plants & have them follow simple commands. Ask about events in the spell's area within the past day.</li>
    <li>Communicate with a Plant creature as if you shared a common language.</li>
    <li>Turn the area into Difficult Terrain or make Difficult Terrain caused by plant growth (such as thickets & undergrowth) into ordinary terrain that lasts for the duration.</li>
    <li>Plants can't change location but can bend/twist/wave/etc.</li>
    </ul>`,
  }),
  createScroll({
  ...
  createScroll({
    ...
    available:
      "SORCERER, WARLOCK, WIZARD, CIRCLE OF THE LAND (COAST), OATH OF THE ANCIENTS, OATH OF VENGEANCE, OATH OF THE SEA",
    tags: "TELEPORTATION",
  ...
  createScroll({
    ...
    available:
      "SORCERER, WIZARD, CIRCLE OF THE LAND (MOUNTAIN), THE FATHOMLESS, ARMORER",
    tags: "DAMAGE",
