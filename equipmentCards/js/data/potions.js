const potionOfHealingHero =
  "https://db4sgowjqfwig.cloudfront.net/campaigns/88422/assets/814917/Potion_of_Healing.png?1515179713";
...
export default [
  createPotion({
    ...
    hero: "https://www.dndbeyond.com/avatars/thumbnails/45205/724/1000/1000/638657413895930892.png",
    rarity: "uncommon",
    tags: "DAMAGE,FORCE,CONSUMABLE,1/2/26",
    weight: 0.5,
  ...
  createPotion({
    ...
    hero: "https://img.ttg.club/item_magic/potion_of_comprehension.webp",
    rarity: "common",
    tags: "COMMUNICATION,CONSUMABLE,1/2/26",
    weight: 0.5,
    description: `For 1 hr, you understand the literal meaning of any language that you hear or see signed. You also understand any written language that you see, but you must be touching the surface on which the words are written. It takes about 1 min to read 1 page of text. This effect doesn't decode symbols or secret messages.
    This potion's liquid is a clear concoction with bits of salt and soot swirling in it.`,
  }),
  createPotion({
    name: "Potion of Clairvoyance",
    hero: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8d3L1NxlBa09HP29ScdNEnZ5KQgmI-Vwl7w&s",
    rarity: "rare",
    tags: "SCRYING,DETECTION,CONSUMABLE,1/2/26",
    weight: 0.5,
    description: `You create an Invisible, intangible, invulnerable sensor within 1 mi in a location familiar to you or in an obvious location that is unfamiliar to you. The sensor remains in place for the duration.
    Choose seeing or hearing. You can use the chosen sense through the sensor as if you were in its space. As a Bonus Action, you can switch.
  ...
  createPotion({
    ...
    hero: "https://creator.nightcafe.studio/jobs/bpjIBTBoo9QDFE5D6UlB/bpjIBTBoo9QDFE5D6UlB--1--upn0f.jpg",
    rarity: "uncommon",
    tags: "ADVANTAGE,MELEE,RANGED,CHECKS,SAVES,1/2/26",
    weight: 0.5,
  ...
  createPotion({
    ...
    damage_effect: "Buff",
    available:
      "SORCERER, WIZARD, ARTIFICER, CIRCLE OF THE LAND (GRASSLAND), OATH OF VENGEANCE, OATH OF GLORY",
    tags: "BUFF",
