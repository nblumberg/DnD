...
export default [
  createWondrousItem({
    name: "Eaton's Handy Spice Pouch",
    hero: "img/Eaton's Handy Spice Pouch.jpg",
    weight: 0.5,
    tags: "1/2/26",
    charges: "10",
    description: `
    <p>This belt pouch appears empty. While holding the pouch, w/ <em>1 action + 1 charge</em>, speak the name of any nonmagical food seasoning, & remove a 1 meal's worth (1 pinch) of it from the pouch. The pouch regains <em>1d6 + 4 expended charges</em> daily at dawn.</p>
    <p>This pouch grants the ability to cook food with the same abilities as magic potions (but not oils).</p>
    <p><b>Replenishing Meal (Short Rest):</b> you can cook special food for <em>4 + Proficiency Bonus</em> creatures w/ ingredients & Cook's Utensils. Any creature who eats the food &  spends 1+ HD to regain HP regains +1d8 HP.</p>
    <p><b>Bolstering Treats (1 hr or Long Rest):</b> cook <em>Proficiency Bonus</em> treats if you have ingredients and Cook's Utensils. These special treats last 8 hours after being made. A creature can use a <em>Bonus Action</em> to eat 1 treat for <em>Proficiency Bonus</em> <em>Temporary HP</em>.</p>
    `,
  }),
  createWondrousItem({
    name: "Clockwork toad",
    hero: "https://pbs.twimg.com/media/DeUnfhuWsAENei6.jpg",
    weight: 0.1,
    tags: "1/2/26",
    description: `A Tiny clockwork toad with AC 5 and 1 hit point. If a creature places the toad on the ground, it hops 5 feet across the ground on each of the creature’s turns in a random direction and makes a croaking noise that can be heard out to a range of 30 feet. Any creature that licks the clockwork toad must succeed on a DC 15 Constitution saving throw or be poisoned for 1 hour. While the creature is poisoned in this way, other creatures are invisible to it.`,
  }),
  createWondrousItem({
    name: "Hourglass eye pendant",
    hero: "https://th.bing.com/th/id/OIG1.vedOujJsSmiPO9jleJjw?pid=ImgGn",
    weight: 0.1,
    tags: "1/2/26",
    description: `A varnished human eyeball inside the lower half of a small hourglass that hangs like a pendant from a necklace made of woven hair.`,
  }),
  createWondrousItem({
    name: "Quill of Endless Ink",
    hero: "https://i.etsystatic.com/7571364/r/il/f3f48f/1540628619/il_1080xN.1540628619_cps9.jpg",
    weight: 0.1,
    tags: "UTILITY,1/2/26",
    description: `A black-feathered quill with a bone tip that magically produces its own ink (150 gp). The ink is the crimson color of fresh blood until it dries, whereupon its color changes to sepia.`,
  }),
  createWondrousItem({
    name: "Bag of Holding",
